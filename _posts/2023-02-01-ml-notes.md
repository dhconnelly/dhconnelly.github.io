...
1. Broad overview: Work through [Google's ML Crash Course](#machine-learning-crash-course). _[Status: Done]_
2. Foundations: Work through [Mathematics for ML](#mathematics-for-machine-learning), [Intro to Statistical Learning](#introduction-to-statistical-learning), [Hands-On Machine Learning](#hands-on-machine-learning). _[Status: Just started]_
3. Practice: Read [Design Machine Learning Systems](#designing-machine-learning-systems) and do some Kaggle competitions. _[Status: Not yet started]_
